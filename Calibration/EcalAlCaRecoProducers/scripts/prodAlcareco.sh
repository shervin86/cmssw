...
echo " --submitOnly"
echo " --check"
echo " --jobname jsonName: additional name in the folder structure to keep track of the used json"
...
#echo " NOT CURRENTLY SUPPORTED --doTree" # arg (=${DOTREE}): 0=no tree, 1=standard tree only, 2=extratree-only, 3=standard+extra trees"
...
echo "CRAB3 config created: ${crabFile}"
